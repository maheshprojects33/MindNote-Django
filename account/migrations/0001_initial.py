    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, default='n/a', max_length=15, null=True)),
                ('country', models.CharField(blank=True, choices=[('NP', 'Nepal'), ('IN', 'India'), ('CH', 'China')], default='NP', max_length=10, null=True)),
